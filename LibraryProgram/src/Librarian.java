...
class Librarian extends User
{
	...
	public static void main(String args[])
	{
		...
		System.out.println(Lib.myBooks[1].toString());
		
		//Test 2: Adding a book with just a name of the book and author.
		System.out.println("Test 2: Adding Another Book");
		Lib.AddBook("Hunger Games", "Suzanne Collins");
		System.out.println(Lib.myBooks[2].toString());
		...
		//Test 7: Fines are 0.
		System.out.println(Lib.GetFine(0));
		
		System.out.println(Lib.GetTotalFine());
	}
